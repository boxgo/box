...
* 生命周期，模块可挂载至box启动器托管启动/停止/前置/后置任务

* 丰富的配置功能，支持多配置源、动态更新配置、配置信息注册/查询

* 协议丰富，支持gRPC、http

* 指标采集，支持自定义指标，易接入Dashboard和报警系统
...
$ 							|____/ \___/_/\_\
$ +----------------+-------------------------------+-------------------------+------------------+------------------------------------------+
$ |      Name      |             Path              |          Type           |     Default      |               Description                |
$ +----------------+-------------------------------+-------------------------+------------------+------------------------------------------+
$ | box            | name                          | string                  | box              |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | traceBizId                    | string                  | box.trace.bizId  |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | traceReqId                    | string                  | box.trace.reqId  |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | traceSpanId                   | string                  | box.trace.spanId |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | traceUid                      | string                  | box.trace.uid    |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | version                       | string                  | unknown          |                                          |
$ +----------------+-------------------------------+-------------------------+------------------+------------------------------------------+
$ | gin.default    | addr                          | string                  | :8000            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | idleTimeout                   | time.Duration           | 5m0s             |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | mode                          | string                  | release          | Gin mode: debug,release,test.            |
$ |                |                               |                         |                  | default is release                       |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | readTimeout                   | time.Duration           | 1m0s             |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | writeTimeout                  | time.Duration           | 1m0s             |                                          |
$ +----------------+-------------------------------+-------------------------+------------------+------------------------------------------+
$ | logger.default | development                   | bool                    | false            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | disableCaller                 | bool                    | true             |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | disableStacktrace             | bool                    | false            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.callerEncoder   | string                  | short            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.callerKey       | string                  | caller           |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.durationEncoder | string                  | ms               |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.levelEncoder    | string                  | capitalColor     |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.levelKey        | string                  | level            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.lineEnding      | string                  |                  |                                          |
$ |                |                               |                         |                  |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.messageKey      | string                  | msg              |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.nameEncoder     | string                  |                  |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.nameKey         | string                  | logger           |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.stacktraceKey   | string                  | stacktrace       |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.timeEncoder     | string                  | iso8601          |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoderConfig.timeKey         | string                  | time             |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | encoding                      | string                  | console          |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | errorOutputPaths              | []string                | [stderr]         |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | initialFields                 | map[string]interface {} | map[]            |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | level                         | zap.AtomicLevel         | info             | debug,info,warn,error,dpanic,panic,fatal |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | outputPaths                   | []string                | [stdout]         |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | sampling.initial              | int                     |              100 |                                          |
$ +                +-------------------------------+-------------------------+------------------+------------------------------------------+
$ |                | sampling.thereafter           | int                     |              100 |                                          |
$ +----------------+-------------------------------+-------------------------+------------------+------------------------------------------+
$ {"box":{"name":"testBox","version":"1.0.0"},"gin":{"default":{"addr":":9000","mode":"release"}},"loader":"memory","logger":{"default":{"errorOutputPaths":["stderr"],"level":"info","outputPaths":["stdout"]}},"reader":"json","source":[{"path":"box.yaml","type":"file"}]}
$ 2020-11-12T23:40:27.113+0800	INFO	serve start...
$ 2020-11-12T23:40:27.114+0800	INFO	serve GinServer
$ 2020-11-12T23:40:28.114+0800	INFO	serve done...

# 输入 ctrl + c 我们看到启动器开始停止工作，然后GinServer被关闭。
